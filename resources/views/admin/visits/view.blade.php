    ...
    <div class="bg-gray-50 p-4 rounded-lg mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col">
          ...
          <span class="font-medium text-gray-900">{{ $visit->province }}</span>
        </div>  
        <div class="flex flex-col"> 
          <span class="text-sm text-gray-500">Kota</span>
          <span class="font-medium text-gray-900">{{ $visit->city }}</span>
        </div>
        <div class="flex flex-col">
    ...
    @if ($visit->attachment_path)
      <div class="bg-gray-50 p-4 rounded-lg">
        ...
        <a 
          ...
          target="_blank" 
          class="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-700 bg-blue-50 rounded-md hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
